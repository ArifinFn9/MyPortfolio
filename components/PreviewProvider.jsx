      ...
      {isOpen && (
        ...
        >
          <div 
            ...
            className="w-full max-w-3xl h-[80vh] flex flex-col glass-card border border-white/10 rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 cursor-default"
